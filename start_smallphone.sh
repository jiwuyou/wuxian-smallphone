...
if [[ -z "${SMALLPHONE_SILLYTAVERN_DIR:-}" ]]; then
  if [[ -d "$ROOT_DIR/sillytavern" ]]; then
    SMALLPHONE_SILLYTAVERN_DIR="$ROOT_DIR/sillytavern"
  elif [[ -d /root/SillyTavern ]]; then
    SMALLPHONE_SILLYTAVERN_DIR="/root/SillyTavern"
  elif [[ -d /root/.local/share/SillyTavern ]]; then
    SMALLPHONE_SILLYTAVERN_DIR="/root/.local/share/SillyTavern"
  else
    SMALLPHONE_SILLYTAVERN_DIR="$ROOT_DIR/sillytavern"
  fi
fi
SMALLPHONE_SILLYTAVERN_DATA_DIR="${SMALLPHONE_SILLYTAVERN_DATA_DIR:-$SMALLPHONE_SILLYTAVERN_DIR/data}"
SMALLPHONE_SILLYTAVERN_HOST="${SMALLPHONE_SILLYTAVERN_HOST:-127.0.0.1}"
SMALLPHONE_SILLYTAVERN_PORT="${SMALLPHONE_SILLYTAVERN_PORT:-8000}"
SMALLPHONE_SILLYTAVERN_URL="${SMALLPHONE_SILLYTAVERN_URL:-http://${SMALLPHONE_SILLYTAVERN_HOST}:${SMALLPHONE_SILLYTAVERN_PORT}/}"
SMALLPHONE_SILLYTAVERN_SERVICE_ID="${SMALLPHONE_SILLYTAVERN_SERVICE_ID:-smallphone-sillytavern}"
...
(
  ...
  SMALLPHONE_SILLYTAVERN_DIR="$SMALLPHONE_SILLYTAVERN_DIR" \
  SMALLPHONE_SILLYTAVERN_DATA_DIR="$SMALLPHONE_SILLYTAVERN_DATA_DIR" \
  SMALLPHONE_SILLYTAVERN_URL="$SMALLPHONE_SILLYTAVERN_URL" \
  SMALLPHONE_SILLYTAVERN_SERVICE_ID="$SMALLPHONE_SILLYTAVERN_SERVICE_ID" \

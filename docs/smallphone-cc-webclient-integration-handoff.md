...
smallphone-app API :22000
        |
        v
cc-connect webclient backend :21040 /apps/smallphone/...
        |
        v
Bridge
        |
...
SmallPhoneAI app-facing 端口合约：

- beta frontend：`100.120.221.72:22082`
- SmallPhone API：`100.120.221.72:22000`
- cc-connect webclient backend：`127.0.0.1:21040`
- service-manager：`127.0.0.1:20087`

兼容和内部端口：

- stable frontend：`100.120.221.72:22080`
- opencode backend：`100.120.221.72:22096`
- cc-connect Bridge：`127.0.0.1:21010`
- cc-connect management：`21020`

注意：SmallPhoneAI 默认打开 `22082`；`22080` 是 stable 兼容入口，不参与 SmallPhoneAI readiness。`18081` 已被文件传输服务占用，不要用于 beta。
...
curl -sS \
  ...
  http://127.0.0.1:21040/apps/smallphone/api/v1/projects/smallphone-3e9fc251/sessions
```
...
11. 验证默认 beta 前端，必要时验证兼容 stable：
